...
InputDirs = [Baseline_InputDir, Random_InputDir, COSSIMMLP_InputDir, STGGNN_InputDir]
methods = ['Baseline', 'Random', 'COSSIMMLP', 'STGGNN']
...
def calc_roc_pr(true_paths, pred_paths, mask_paths, target_idx):
    ...
    for idx in target_idx:
        ...
        pred_T = pred.T
        pred[pred_T > pred] = pred_T[pred_T > pred] # 無向グラフに変換
